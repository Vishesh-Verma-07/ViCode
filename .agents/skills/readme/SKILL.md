---
name: readme
description: Generate a professional, recruiter-friendly README.md for a software project. Use when asked to write, generate, create, update, or rewrite a GitHub README or project readme. Analyzes project files, structure, and configs without inventing details, and asks for the author's name if unknown.
---
